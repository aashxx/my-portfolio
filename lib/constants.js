...
import { SiTailwindcss, SiGraphql, SiApollographql, SiNextdotjs, SiTypescript, SiRedux, SiMui, SiChakraui, SiVite, SiElectron, SiExpress, SiMongodb, SiPostgresql, SiFirebase, SiSupabase, SiPrisma, SiMongoose, SiDrizzle, SiShadcnui, SiZod, SiSass, SiGooglecloud, SiStripe, SiJsonwebtokens, SiGmail } from 'react-icons/si';
...
export const EXPERIENCE = {
  ...
  title: "My experience",
  description:
    "Over the past three years, I've worked with two automation startups, managed several freelance projects, and served as a solutions consultant at a mid-sized company.",
  info: [
    {
...
export const EDUCATION = {
  ...
  title: "My education",
  description:
    "I hold a Bachelor's degree in Computer Science Engg. with a CGPA of 9.54 and have earned additional certifications in software development.",
  info: [
    {
    ...
    },
    {
      ...
      duration: "2023 (MOOC Cert.)",
    },
    {
      institution: "freeCodeCamp",
      degree: "JS Algorithms and Data Structures",
      duration: "2022 (Cert.)",
    },
    {
...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Familiar with no code / low code platforms including Kissflow.",
    href: "#contact",
  },
];
